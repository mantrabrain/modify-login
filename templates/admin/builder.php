...
<div id="modify-login-builder" class="h-[calc(100vh-32px)] bg-gray-50 p-5">
    <div class="flex h-full gap-6">
        <!-- Left Panel -->
        <div class="w-96 min-w-96 bg-white shadow-md flex flex-col overflow-hidden">
            ...
            <div class="panel-content flex-1 overflow-y-auto p-5">
                <!-- Background Card -->
                <div class="card bg-white border border-gray-200 rounded-lg mb-5 overflow-hidden transition-shadow hover:shadow">
                    ...
                    <div class="p-4">
                        <div class="form-group mb-4 last:mb-0">
                            ...
                            <input type="color" id="background_color" name="background_color" value="<?php echo esc_attr($settings['background_color']); ?>" class="w-full h-10 p-0.5 border border-gray-300 rounded-md">
                        </div>
                        <div class="form-group mb-4 last:mb-0">
                            <label for="background_image" class="block mb-2 text-sm font-medium text-gray-700"><?php _e('Background Image', 'modify-login'); ?></label>
                            <div class="media-upload-wrapper flex gap-2">
                                <input type="text" id="background_image" name="background_image" value="<?php echo esc_attr($settings['background_image']); ?>" class="flex-1 px-3 py-2.5 border border-gray-300 rounded-md text-sm text-gray-800 bg-white transition-all hover:border-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                                <button class="upload-button px-3 py-2.5 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white cursor-pointer transition-all hover:bg-gray-50 hover:border-gray-400"><?php _e('Upload', 'modify-login'); ?></button>
                                <button class="remove-button px-3 py-2.5 border border-red-500 rounded-md text-sm font-medium text-red-500 bg-white cursor-pointer transition-all hover:bg-red-500 hover:text-white" data-target="background_image"><?php _e('Remove', 'modify-login'); ?></button>
                                <button class="toggle-image-properties px-2 py-2.5 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white cursor-pointer transition-all hover:bg-gray-50 hover:border-gray-400" data-target="background-properties">
                                    <span class="dashicons dashicons-admin-generic text-base w-4 h-4"></span>
                                </button>
                            </div>
                ...
                <div class="card bg-white border border-gray-200 rounded-lg mb-5 overflow-hidden transition-shadow hover:shadow">
                    ...
                    <div class="p-4">
                        <div class="form-group mb-4 last:mb-0">
                            ...
                            <div class="media-upload-wrapper flex gap-2">
                                <input type="text" id="logo_url" name="logo_url" value="<?php echo esc_attr($settings['logo_url']); ?>" class="flex-1 px-3 py-2.5 border border-gray-300 rounded-md text-sm text-gray-800 bg-white transition-all hover:border-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                                <button class="upload-button px-3 py-2.5 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white cursor-pointer transition-all hover:bg-gray-50 hover:border-gray-400"><?php _e('Upload', 'modify-login'); ?></button>
                                <button class="remove-button px-3 py-2.5 border border-red-500 rounded-md text-sm font-medium text-red-500 bg-white cursor-pointer transition-all hover:bg-red-500 hover:text-white" data-target="logo_url"><?php _e('Remove', 'modify-login'); ?></button>
                                <button class="toggle-image-properties px-2 py-2.5 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white cursor-pointer transition-all hover:bg-gray-50 hover:border-gray-400" data-target="logo-properties">
                                    <span class="dashicons dashicons-admin-generic text-base w-4 h-4"></span>
                                </button>
                            </div>
                ...
                <div class="card bg-white border border-gray-200 rounded-lg mb-5 overflow-hidden transition-shadow hover:shadow">
                    ...
                    <div class="p-4">
                        <div class="form-group mb-4 last:mb-0">
                            ...
                            <input type="color" id="form_background" name="form_background" value="<?php echo esc_attr($settings['form_background']); ?>" class="w-full h-10 p-0.5 border border-gray-300 rounded-md">
                        </div>
                        <div class="form-group mb-4 last:mb-0">
                ...
                <div class="card bg-white border border-gray-200 rounded-lg mb-5 overflow-hidden transition-shadow hover:shadow">
                    ...
                    <div class="p-4">
                        <div class="form-group mb-4 last:mb-0">
                            ...
                            <input type="color" id="button_color" name="button_color" value="<?php echo esc_attr($settings['button_color']); ?>" class="w-full h-10 p-0.5 border border-gray-300 rounded-md">
                        </div>
                        <div class="form-group mb-4 last:mb-0">
                            ...
                            <input type="color" id="button_text_color" name="button_text_color" value="<?php echo esc_attr($settings['button_text_color']); ?>" class="w-full h-10 p-0.5 border border-gray-300 rounded-md">
                        </div>
                    </div>
                </div>
        ...
        <!-- Preview Panel -->
        <div class="flex-1 bg-white shadow-md overflow-hidden">
            <div class="h-full p-6 flex items-center justify-center bg-gray-50">
                <iframe id="login-preview" src="<?php echo wp_login_url(); ?>" class="w-full h-full border-none rounded-lg bg-white shadow"></iframe>
            </div>
        </div>
    </div>
</div>